; Transport two-cities-sequential-12nodes-1000size-3degree-100mindistance-3trucks-8packages-2008seed

(define (problem transport-two-cities-sequential-12nodes-1000size-3degree-100mindistance-3trucks-8packages-2008seed)
 (:domain transport)
 (:objects
