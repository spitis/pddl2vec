; Transport three-cities-sequential-63nodes-1000size-4degree-100mindistance-4trucks-30packages-2014seed

(define (problem transport-three-cities-sequential-63nodes-1000size-4degree-100mindistance-4trucks-30packages-2014seed)
 (:domain transport)
 (:objects
 ...
 (:goal (and
  ...
  (at package-28 city-1-loc-50)
  (at package-29 city-1-loc-35)
  (at package-30 city-3-loc-33)
 ))
)
