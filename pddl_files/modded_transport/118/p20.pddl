; Transport three-cities-sequential-66nodes-1000size-4degree-100mindistance-5trucks-25packages-2014seed

(define (problem transport-three-cities-sequential-66nodes-1000size-4degree-100mindistance-5trucks-25packages-2014seed)
 (:domain transport)
 (:objects
 ...
 (:goal (and
  ...
  (at package-23 city-2-loc-56)
  (at package-24 city-1-loc-20)
  (at package-25 city-2-loc-37)
 ))
)
